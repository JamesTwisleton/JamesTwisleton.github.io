...
.controller('EventsCtrl', ['$scope', '$firebaseObject', '$firebaseArray', function($scope, $firebaseObject, $firebaseArray) {
	...
	refPath = "";	
	$scope.event = [];
	$scope.event = $firebaseArray(firebase.database().ref());
